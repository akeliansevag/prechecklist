<?php get_header();?>
  <?php $post = get_post(); 
  $cat=(!empty(get_the_category($post)) ? get_the_category($post)[0]->name : '');
  ?>
  <section class="mt-5 animatedParent animateOnce">
    <div class="container animated fadeIn">
      <a class="back-to" href="<?=get_permalink( get_page_by_path( $cat) )?>"><svg width="30px" height="30px" viewBox="0 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
